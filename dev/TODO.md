...
1.  Rename [_testing](../splatlog/_testing.py) to `splatlog/tests.py` since it's
    now exported.
...
2.  Rename [reporting](../splatlog/reporting.py) to `splatlog/reports.py`.
...
3.  Merge [lib/typeguard](../splatlog/lib/typeguard.py) into
...
7.  `SlotCachedProperty` placement.
...
8.  Attribution for `loop_*` functions.
